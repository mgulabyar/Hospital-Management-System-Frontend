            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
              <div>
                ...
                <div className="relative w-full">
                  <select
                    ...
                    className="w-full cursor-pointer appearance-none rounded-md border border-slate-200 bg-slate-50 py-2.5 pl-3 pr-10 text-[11px] font-bold uppercase text-slate-500 outline-none transition-all focus:border-[#029352] focus:bg-white focus:ring-2 focus:ring-[#029352]/10"
                  >
              ...
              <div>
                ...
                <div className="relative w-full">
                  <select
                    ...
                    className="w-full cursor-pointer appearance-none rounded-md border border-slate-200 bg-slate-50 py-2.5 pl-3 pr-10 text-[11px] font-bold uppercase text-slate-500 outline-none transition-all focus:border-[#029352] focus:bg-white focus:ring-2 focus:ring-[#029352]/10 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    <option value="">
                      {!departmentId
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2.5 text-[11px] font-semibold text-slate-500 outline-none transition-all focus:border-[#029352] focus:bg-white focus:ring-2 focus:ring-[#029352]/10"
                />
              </div>
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-[#1a4b8c] px-4 py-3 text-[10px] font-bold uppercase tracking-wider text-white shadow-sm transition-all hover:bg-[#143b6e] focus:outline-none focus:ring-2 focus:ring-[#029352]/30 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {bookingLoading ? (
                    <>
      ...
      <div className="rounded-lg border border-slate-200/80 bg-white p-5 shadow-sm">
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-md border border-slate-200 bg-slate-50 py-2.5 pl-9 pr-3 text-[11px] font-semibold text-slate-500 outline-none transition-all focus:border-[#029352] focus:bg-white focus:ring-2 focus:ring-[#029352]/10"
              />
            </div>
            ...
            <div className="relative w-full">
              <select
                ...
                className="w-full cursor-pointer appearance-none rounded-md border border-slate-200 bg-slate-50 py-2.5 pl-3 pr-10 text-[11px] font-semibold uppercase text-slate-500 outline-none transition-all focus:border-[#029352] focus:bg-white focus:ring-2 focus:ring-[#029352]/10"
              >
        ...
        {!loading && appointments.length > 0 && (
          <div className="overflow-x-auto rounded-lg border border-slate-200/60">
            <table className="w-full min-w-278 border-collapse text-left">
              <thead>
