...
export const ReceptionistWorkspace: React.FC = () => {
  ...
  }, [fetchDepartments, fetchPatients, showToast]);
  ...
  }, [fetchDoctorsByDepartment, selectedDepartmentId, showToast]);
  ...
  const handleRegisterPatientForm = async (
    ...
    try {
      ...
      if (response.success && response.data) {
        showToast(
          `Success: Patient folder assigned official UHID ${response.data.patientId}`,
          "success",
        );
